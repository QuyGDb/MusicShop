...
import { useAdminProduct, useDeleteProductVariant } from '@/features/products/hooks/useProducts';
import { useState } from 'react';
import { ReleaseFormat } from '@/features/products/types';
import { VariantFormModal } from '@/features/admin';
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          {/* <Button variant="outline" className="h-12 px-6 rounded-xl border-border flex gap-2">
            <History className="h-4 w-4" />
            Audit Logs
          </Button> */}
          <Button className="h-12 px-6 rounded-xl bg-surface border border-border text-foreground hover:bg-muted flex gap-2">
