...
const MOCK_ORDERS: Order[] = [
  { id: 'ORD-7721', customerName: 'John Doe', email: 'john@example.com', date: '2026-04-18', total: 125.50, status: OrderStatus.Confirmed, itemsCount: 3 },
  { id: 'ORD-7722', customerName: 'Jane Smith', email: 'jane@example.com', date: '2026-04-19', total: 45.00, status: OrderStatus.Pending, itemsCount: 1 },
  { id: 'ORD-7723', customerName: 'Mike Johnson', email: 'mike@example.com', date: '2026-04-19', total: 89.99, status: OrderStatus.Shipped, itemsCount: 2 },
  { id: 'ORD-7724', customerName: 'Sarah Williams', email: 'sarah@example.com', date: '2026-04-20', total: 210.00, status: OrderStatus.Delivered, itemsCount: 5 },
  { id: 'ORD-7725', customerName: 'David Brown', email: 'david@example.com', date: '2026-04-20', total: 60.00, status: OrderStatus.Cancelled, itemsCount: 2 },
];
