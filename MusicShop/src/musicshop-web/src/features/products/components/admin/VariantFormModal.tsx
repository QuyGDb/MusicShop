...
export function VariantFormModal({ productId, format, editingVariant, onClose }: VariantFormModalProps) {
  ...
  const { form, isPending } = useVariantForm({
    productId,
    format,
    editingVariant,
    onSuccess: onClose,
        ...
        <CardContent className="p-0 overflow-y-auto">
          ...
          >
             ...
             <div className="pt-8 border-t border-border space-y-6">
                ...
                {format === ReleaseFormat.Vinyl && <VinylAttributesFields form={form} />}
                {format === ReleaseFormat.CD && <CDAttributesFields form={form} />}
                {format === ReleaseFormat.Cassette && <CassetteAttributesFields form={form} />}
             </div>
