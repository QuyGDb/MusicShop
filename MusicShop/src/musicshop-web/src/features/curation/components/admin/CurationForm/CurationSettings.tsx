      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <input
            type="text"
            {...register('title')}
            className={`w-full h-12 bg-surface border rounded-xl px-4 focus:outline-none transition-all font-bold ${errors.title ? 'border-red-500 focus:border-red-500' : 'border-border focus:border-primary'
              }`}
          />
          {errors.title && (
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className={`w-full bg-surface border rounded-xl p-4 focus:outline-none transition-all text-sm resize-none ${errors.description ? 'border-red-500 focus:border-red-500' : 'border-border focus:border-primary'
              }`}
          />
          {errors.description && (
      ...
      <div className="space-y-4 pt-6 border-t border-border">
        ...
        <div className="space-y-2 max-h-[300px] overflow-y-auto px-1">
          {isSearching ? (
            ...
            <p className="text-[10px] text-center text-muted-foreground py-4 italic">Search for available releases</p>
          )}
        </div>
      </div>
    </div>
